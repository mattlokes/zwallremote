...
const uint8 zclSampleSw_ManufacturerName[] = { 16, 'M','a','t','t',' ','I','n','s','t','r','u','m','e','n','t','s' };
const uint8 zclSampleSw_ModelId[] = { 12, 'Z','W','a','l','l','R','e','m','o','t','e','0'};
const uint8 zclSampleSw_DateCode[] = { 16, '2','0','1','9','0','4','0','5',' ',' ',' ',' ',' ',' ',' ',' ' };
const uint8 zclSampleSw_PowerSource = POWER_SOURCE_BATTERY;
...
#define ZCLSAMPLESW_MAX_OUTCLUSTERS    ( ( sizeof( zclSampleSw_OutClusterList ) / sizeof( zclSampleSw_OutClusterList[0] ) ) - 1 )
